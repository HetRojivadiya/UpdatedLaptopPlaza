  ...
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      user: 'hetrojivadia999@gmail.com',
      pass: 'albatross123@@@',
    },
  });
  ...
  const mailOptions = {
    from: 'hetrojivadia999@gmail.com',
    to: 'hetrojivadiya999@example.com',
  ...
  const transporter = nodemailer.createTransport({
    service: 'gmail', // Use the email service you prefer (e.g., 'gmail', 'hotmail', 'yahoo')
    auth: {
      user: 'hetrojivadiya999@gmail.com',
      pass: 'vdykzjhajlurkbch',
    },
  });
  
  // Define the email options
  const mailOptions = {
    from: 'hetrojivadiya999@gmail.com',
    to: user.email,
